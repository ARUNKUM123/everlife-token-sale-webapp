  ...
  <v-layout column>
    ...
    <v-layout>
        ...
        <v-card height="418px">
          ...
          <button data-v-358c3dbb="" type="button" class="mt-3 v-btn v-btn--large blue darken-2 white--text" style="position: relative; margin-left: 0px;">
          <div class="v-btn__content">
      <a href="/contribute" style="color: white;padding: 10px; text-decoration: none;">Purchase EVER</a>
      </div></button>

        
            </td><td style="padding: 10px;padding-top: 0px; padding-bottom: 50px;"> 
